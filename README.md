...
The following datasets were created by the group to facilitate testing and evaluation of the algorithms, particularly for more computationally expensive approaches such as A* and Beam Search:
